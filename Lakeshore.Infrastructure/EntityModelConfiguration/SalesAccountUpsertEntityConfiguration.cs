...
{
    public class SalesAccountUpsertEntityConfiguration : IEntityTypeConfiguration<Domain.Models.SalesAccountUpsert>
    {
        public void Configure(EntityTypeBuilder<Domain.Models.SalesAccountUpsert> entity)
        {
            ...
            entity.Property(e => e.AccountCategoryTerritory).HasColumnName("Acct_Cat_Territory__c");
